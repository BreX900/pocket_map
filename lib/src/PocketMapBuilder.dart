...
class PocketMapBuilder extends StatelessWidget {
  ...
  PocketMapBuilder({Key key, @required this.builder, this.padding: const EdgeInsets.all(16.0)})
      : assert(builder != null),
        super(key: key); // 17
    ...
    return Stack(
      children: <Widget>[
        builder(context, (controller) {
          if (containerController.isCompleted) return;
          containerController.complete(controller);
        }),
